...
function AppShell() {
  ...
  const [locationSettingsBackRoute, setLocationSettingsBackRoute] =
    useState<AppRoute>("settings");
    ...
    <main className="min-h-dvh">
      ...
      {route === "overview" ? (
        <OverviewScreen
          ...
          onOpenLocationSettings={() => {
            setLocationSettingsBackRoute("overview");
      ...
      {route === "settings" ? (
        <SettingsScreen
          ...
          onOpenLocation={() => {
            setLocationSettingsBackRoute("settings");
            navigate("location-settings");
          }}
          onOpenMap={() => navigate("map")}
      ...
      {route === "location-settings" ? (
        <LocationSettingsScreen
          isAutomaticFallback={locationSettingsBackRoute === "overview"}
          onBack={() => navigate(locationSettingsBackRoute)}
          preferences={preferences}
